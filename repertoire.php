	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				<div class="shaded_div">
					...
					if ($id > 0) {
						...
						// Redirect Retired Song to retired repertoire page
						if ($row['archived']) header('location: retired_repertoire.php?id=' . $id);
			...
			{ ?><div>
					...
					if ($i == 0)
					{ ?>
						<p>There are currently no songs in the repertoire.</p>
					<?php } ?>
