...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>Forgot Password - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				<form method="post" action="members/actions/admin/forgot_password.php" style="display:block;text-align:center">
					<div>
						<label for="email"><h1>Forgot Your Password?</h1></label>
