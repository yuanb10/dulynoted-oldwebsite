...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>Send Group TXT to Members - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				<h1>Group TXT Message</h1>
				<form name="editbox" method="post" action="members/actions/send/txt.php">
					<div>
						<textarea name="txt" id="txt" maxlength="140" style="width:764px;height:100px;font-size:125%"></textarea>
						<br /><input type="submit" name="submit" value="Send TXT" style="display:block;margin:0 auto;" />
					</div>
				</form>
