...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>Delete Post - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				if ($post['deleted']) header ("location: http://dulynoted.union.rpi.edu/members/includes/error.php?error=This post has already been deleted!");
				else {
				
				// Setup Member Log
				$action = 'deleted post <a href="news_feed.php?id=' . $id . '">' . $post['title'] . '</a>';
				
				// Update Post on the MySQL Database
				mysql_query("UPDATE posts SET deleted=1 WHERE id='$id'");
				...
				<h1><a href="news_feed.php?id=<?php echo $id; ?>"><?php echo $post['title']; ?></a> Deleted</h1>
				<p class="centered">
					<a href="news_feed.php?id=<?php echo $id; ?>"><?php echo $post['title']; ?></a> has been successfully deleted.<br />
					<a href="members/actions/restore/post.php?id=<?php echo $id; ?>">Restore</a> |
