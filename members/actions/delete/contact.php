...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>Delete Contact - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				// Return Error if Contact already deleted
				if ($contact['deleted']) header ("location: http://dulynoted.union.rpi.edu/members/includes/error.php?error=This contact has already been deleted!");
				else {
				
				// Setup Member Log
				$action = 'deleted contact <a href="members/find_contact.php?id=' . $id . '">' . $contact['name'] . '</a>';
				...
				<h1><a href="members/contacts.php?id=<?php echo $id; ?>"><?php echo $contact['name']; ?></a> Deleted</h1>
				<p class="centered">
					<a href="members/contacts.php?id=<?php echo $id; ?>"><?php echo $contact['name']; ?></a> has been successfully deleted.<br />
					<a href="members/actions/restore/contact.php?id=<?php echo $id; ?>">Restore</a> |
