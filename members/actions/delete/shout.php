...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>Delete Shout - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				// Find Shout to Delete
				$shout = mysql_fetch_array(mysql_query("SELECT memberid FROM shoutbox WHERE id='$id'"));
				
				// Return Error if Member not Officer or original poster
				if ($memberid != $shout['memberid'] && $_SESSION['isofficer'] != 'yes') header ("location: http://dulynoted.union.rpi.edu/members/includes/error.php?error=You must be a club officer or the original poster to delete this shout!");
				else {
				
				// Setup Member Log
				$action = 'deleted a <a href="members/shoutbox.php?id=' . $id . '">shout</a>';
				
				// Update Shout on the MySQL Database
				...
				<h1><a href="members/shoutbox.php?id=<?php echo $id; ?>">Shout</a> Deleted</h1>
				<p class="centered">
					<a href="members/shoutbox.php?id=<?php echo $id; ?>">Shout</a> has been successfully deleted.<br />
					<a href="members/shoutbox.php">Go Back</a>
				</p>
