...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>Update Post - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				$id = cleanse ($_SESSION['atomid']);
				$title = cleanse ($_POST['title']);
				$content = cleanse ($_POST['content']);
				
				// Setup Member Log
				$action = 'updated post <a href="news_feed.php?id=' . $id . '">' . $title . '</a>';
				
				// Validate Posted Variables
				validate(array($id, $title, $content, $memberid));
				
				// Update Post on the MySQL Database
				mysql_query("UPDATE posts SET title='$title', content='$content' WHERE id='$id'");
				...
				<h1><a href="news_feed.php?id=<?php echo $id; ?>"><?php echo $title; ?></a> Updated</h1>
				<p class="centered">
					<a href="news_feed.php?id=<?php echo $id; ?>"><?php echo $title; ?></a> has been successfully updated.<br />
