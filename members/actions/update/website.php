...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>Update Website Access Info - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				// Setup Member Log
				$action = 'updated access info for <a href="websites.php?id=' . $id . '">' . $name . '</a>';
				
				// Validate Posted Variables
				validate(array($id, $name, $website, $username, $password));
				
				// Update Website Access Info on the MySQL Database
				mysql_query("UPDATE websites SET name='$name', website='$website', username='$username', password='$password' WHERE id='$id'");
				...
				<h1><a href="members/websites.php?id=<?php echo $id; ?>"><?php echo $name; ?></a> Updated</h1>
				<p class="centered">
					<a href="members/websites.php?id=<?php echo $id; ?>"><?php echo $name; ?></a> has been successfully updated.<br />
