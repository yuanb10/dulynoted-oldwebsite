...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>Update Contact - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				$id = cleanse ($_SESSION['contactid']);
				$school = cleanse ($_POST['school']);
				$name = cleanse ($_POST['name']);
				$website = cleanse ($_POST['website']);
				$email = cleanse ($_POST['email']);
				
				// Setup Member Log
				$action = 'updated contact <a href="members/contacts.php?id=' . $id . '">' . $name . '</a>';
				
				// Validate Posted Variables
				validate(array($id, $school, $name, $website, $email, $memberid));
				
				// Update Contact on the MySQL Database
				mysql_query("UPDATE contacts SET school='$school', name='$name', website='$website', email='$email' WHERE id='$id'");
				...
				<h1><a href="members/contacts.php?id=<?php echo $id; ?>"><?php echo $name; ?></a> Updated</h1>
				<p class="centered">
					<a href="members/contacts.php?id=<?php echo $id; ?>"><?php echo $name; ?></a> has been successfully updated.<br />
