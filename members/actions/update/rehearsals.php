...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>Update Rehearsal Schedule - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				// Update Rehearsals on the MySQL Database
				mysql_query("UPDATE rehearsals SET schedule='$schedule' WHERE id=1");
				
				// Setup Member Log
				$action = 'updated rehearsal times';
				...
				<h1>Rehearsal Times Updated</h1>
				<p class="centered">
					Rehearsal Times have been successfully updated.<br />
					<a href="members/schedule.php">Go Back</a>
				</p>
