	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				$id = cleanse ($_SESSION['attendanceid']);
				...
				mysql_query("UPDATE attendance SET dtstamp='$dtstamp', ontime='$ontime', late='$late', absent='$absent', excused='$excused' WHERE id='$id'");
				
				// Setup Member Log
				$action = 'updated rehearsal attendance for <a href="members/attendance.php?id=' . $id . '">' . $dtstamp . '</a>';
				...
				<h1>Attendance for <a href="members/attendance.php?id=<?php echo $id; ?>"><?php echo $dtstamp; ?></a> Updated</h1>
				<p class="centered">
					Rehearsal attendance for <a href="members/attendance.php?id=<?php echo $id; ?>"><?php echo $dtstamp; ?></a> has been successfully updated.<br />
