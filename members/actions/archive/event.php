...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>Archive Event - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				// Find Event to Archive
				$event = mysql_fetch_array(mysql_query("SELECT summary, archived FROM events WHERE id='$id'"));
				
				// Return Error if Event is already archived
				if ($event['archived']) header ("location: http://dulynoted.union.rpi.edu/members/includes/error.php?error=This event has already been archived!");
				else {
				
				// Setup Member Log
				$action = 'archived event <a href="events.php?id=' . $id . '">' . $event['summary'] . '</a>';
				...
				<h1><a href="events.php?id=<?php echo $id; ?>"><?php echo $row['summary']; ?></a> Archived</h1>
				<p class="centered">
					<a href="events.php?id=<?php echo $id; ?>"><?php echo $row['summary']; ?></a> has been successfully archived.<br />
					<a href="members/actions/restore/event.php?id=<?php echo $id; ?>">Restore</a> |
