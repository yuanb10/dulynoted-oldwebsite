...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>Vote No - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				// Add Vote in Opposion of song
				if (!(array_search($memberid, $supporters) || array_search($memberid, $opposers))) $no = $vote['no'] . ' ' . $memberid;
				else $no = $vote['no'];
				
				// Calculate Vote Score
				$score = count($supporters) - count(explode(" ", $no));
				
				// Setup Member Log
				$action = 'voted against <a href="members/votes.php?id=' . $id . '">' . $vote['title'] . '</a>';
				
				// Update Post on the MySQL Database
				mysql_query("UPDATE votes SET no='$no', score='$score' WHERE id='$id'");
				...
				<h1>Vote against <a href="members/votes.php?id=<?php echo $id; ?>"><?php echo $vote['title']; ?></a> Submitted</h1>
				<p class="centered">
					Your vote against <a href="members/votes.php?id=<?php echo $id; ?>"><?php echo $vote['title']; ?></a> has been successfully submitted.<br />
