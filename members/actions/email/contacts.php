	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				$contacts = cleanse ($_POST['contacts']);
				$subject = cleanse ($_REQUEST['subject']);
				$body = stripslashes(trim($_REQUEST['body']));
				
				// Validate Posted Variables
				validate(array($contacts, $subject, $body, $memberid));
				
				// Setup Member Log
				$action = 'sent an email to the <a href="members/contacts.php">contact list</a>';
				...
				<p class="centered">
					<?php echo $subject; ?> has been successfully sent to the selected a cappella groups.<br />
					<a href="members/email_contacts.php">Go Back</a>
				</p>
