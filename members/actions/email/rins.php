	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				$sendto = cleanse ($_POST['sendto']);
				$subject = cleanse ($_REQUEST['subject']);
				$body = stripslashes(trim($_REQUEST['body']));
				
				// Validate Posted Variables
				validate(array($sendto, $subject, $body, $memberid));
				
				// Setup Member Log
				$action = 'sent an email listing our members to the Union Admin';
				
				// Send Email to the Union Admin
				mail($sendto, $subject, $body, "From: DulyNotedRPI@gmail.com\r\nBCC: DulyNotedRPI@gmail.com");
				...
				<p class="centered">
					<?php echo $subject; ?> has been successfully sent to the Union Admin.<br />
					<a href="members/email_rins.php">Go Back</a>
				</p>
