...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>Lock File - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				// Find File to Lock
				$file = mysql_fetch_array(mysql_query("SELECT filename, locked FROM uploads WHERE id='$id'"));
				
				// Return Error if File already locked
				if ($file['locked']) header ("location: http://dulynoted.union.rpi.edu/members/includes/error.php?error=This file has already been locked!");
				else {
				
				// Setup Member Log
				$action = 'locked file <a href="members/uploads.php?id=' . $id . '">' . $file['filename'] . '</a>';
				
				// Update File on the MySQL Database
				mysql_query("UPDATE uploads SET locked=1 WHERE id='$id'");
				...
				<h1><a href="members/uploads.php?id=<?php echo $id; ?>"><?php echo $file['filename']; ?></a> Locked</h1>
				<p class="centered">
					<a href="members/uploads.php?id=<?php echo $id; ?>"><?php echo $file['filename']; ?></a> has been successfully locked.<br />
