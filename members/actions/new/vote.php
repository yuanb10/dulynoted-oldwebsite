...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>New Song Vote - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				validate(array($artist, $title, $memberid));
				
				// Update Song on the MySQL Database
				mysql_query("INSERT INTO votes (memberid, artist, title, youtube) VALUES ('$memberid', '$artist', '$title', '$youtube')");
				
				// Search for and fetch Song from the MySQL Database
				$vote = mysql_fetch_array(mysql_query("SELECT id FROM votes ORDER BY id DESC LIMIT 1"));
				
				// Setup Member Log
				$action = 'created song vote <a href="members/votes.php?id=' . $vote['id'] . '">' . $title . '</a>';
				...
				<h1><a href="votes.php?id=<?php echo $vote['id']; ?>"><?php echo $title; ?></a> Submitted</h1>
				<p class="centered">
					<a href="votes.php?id=<?php echo $vote['id']; ?>"><?php echo $title; ?></a> has been successfully submitted.<br />
