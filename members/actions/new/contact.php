...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>New Contact - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				validate(array($school, $name, $website, $email, $memberid));
				
				// Update Contact on the MySQL Database
				mysql_query("INSERT INTO contacts (school, name, website, email) VALUES ('$school', '$name', '$website', '$email')");
				
				// Search for and fetch Contact from the MySQL Database
				$contact = mysql_fetch_array(mysql_query("SELECT id FROM contacts ORDER BY id DESC LIMIT 1"));
				
				// Setup Member Log
				$action = 'created contact <a href="members/contacts.php?id=' . $contact['id'] . '">' . $name . '</a>';
				...
				<h1><a href="members/contacts.php?id=<?php echo $contact['id']; ?>"><?php echo $name; ?></a> Created</h1>
				<p class="centered">
					<a href="members/contacts.php?id=<?php echo $contact['id']; ?>"><?php echo $name; ?></a> has been successfully created.<br />
