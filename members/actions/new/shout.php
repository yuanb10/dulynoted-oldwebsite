...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>Post Shout - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				validate(array($content, $memberid));
				
				// Update Shout on the MySQL Database
				mysql_query("INSERT INTO shoutbox (memberid, content) VALUES ('$memberid', '$content')");
				
				// Search for and fetch Shout from the MySQL Database
				$shout = mysql_fetch_array(mysql_query("SELECT id FROM shoutbox ORDER BY id DESC LIMIT 1"));
				
				// Setup Member Log
				$action = 'wrote a <a href="members/shoutbox.php?id=' . $shout['id'] . '">shout</a>';
				...
				<h1><a href="members/shoutbox.php?id=<?php echo $id; ?>">Shout</a> Posted</h1>
				<p class="centered">
					<a href="members/shoutbox.php?id=<?php echo $id; ?>">Shout</a> has been successfully posted.<br />
