...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>Create a New Atom Post - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				<h1>New Post</h1>
				<form name="editbox" method="post" action="members/actions/new/post.php">
					<div>
						<label for="title">Title</label>
						<br /><input type="text" name="title" id="title" maxlength="64" />
						<br /><label for="content">Content</label>
						<br /><textarea name="content" id="content" maxlength="1000" style="width:764px;height:100px"></textarea>
						<br /><input type="submit" name="submit" value="Submit New Post" style="display:block;margin:0 auto;" />
					</div>
				</form>
