...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>Edit Canvas - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
		...
		<div class="container">
			...
			<div class="canvas">
				...
				<?php
					...
					// Search for and fetch Canvas Elements from the MySQL Database //
					$row = mysql_fetch_array(mysql_query("SELECT logo, navbar, tray FROM canvas WHERE id=1"));
					
				?>
				<h1>Edit Canvas</h1>
				<form name="editbox" method="post" action="members/actions/update/canvas.php">
					<div>
						<label for="logo">Logo</label>
						<br /><textarea name="logo" id="logo" maxlength="10000" style="width:764px;height:100px"><?php echo htmlspecialchars($row['logo']); ?></textarea>
						<br /><label for="navbar">Navigation Menu</label>
						<br /><textarea name="navbar" id="navbar" maxlength="10000" style="width:764px;height:100px"><?php echo htmlspecialchars($row['navbar']); ?></textarea>
						<br /><label for="tray">Information Tray</label>
						<br /><textarea name="tray" id="tray" maxlength="10000" style="width:764px;height:100px"><?php echo htmlspecialchars($row['tray']); ?></textarea>
