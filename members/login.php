...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<head>
		...
		<title>Member Login - Duly Noted All-Male A Cappella - RPI Troy, NY</title>
	...
	<body>
		<div class="container">
			...
			<div class="canvas">
				...
				<form method="post" action="members/actions/admin/login.php" style="display:block;text-align:center">
					<div>
						<label for="username"><h1>Member Login</h1></label>
				...
				<p class="centered"><a href="members/forgot_password.php">Forgot Your Password?</a></p>
